    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (callingBundle != null) {
            ...
            if(savedInstanceState == null) {
                ...
                startFragment = getSupportFragmentManager().findFragmentByTag(restaurantTag);
                findFragment = getSupportFragmentManager().findFragmentByTag(tableTag);
                profileFragment = getSupportFragmentManager().findFragmentByTag(profileTag);
                prevFragment = getSupportFragmentManager().findFragmentById(R.id.theFrame);
            }
        }
        else{
